...
namespace DataSearches
{
    ...
    /// consumes native resources (e.g., <see cref="Geodatabase"/> or <see cref="FeatureClass"/>),
    ...
    /// <see cref="Geodatabase"/>.  Consider the case of a file geodatabase that needs to be deleted
    ...
    /// <see cref="Geodatabase"/> or <see cref="FeatureClass"/>, you should declare
    ...
    /// </para>
    /// <para>
    /// - Those that are derived from <see cref="Datastore"/> (e.g., <see cref="Geodatabase"/>).
    /// </para>
    /// <para>
    /// - Those that are derived from <see cref="Dataset"/> (e.g., <see cref="Table"/>).
    /// </para>
    /// <para>
    /// - <see cref="RowCursor"/> and <see cref="RowBuffer"/>.
    /// </para>
    /// <para>
    /// - <see cref="Row"/> and <see cref="Feature"/>.
    /// </para>
    /// <para>
    /// - <see cref="Selection"/>.
    /// </para>
    /// <para>
    /// - <see cref="VersionManager"/> and <see cref="ArcGIS.Core.Data.Version"/>.
    /// </para>
    /// </remarks>
